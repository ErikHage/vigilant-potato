...
public class MessageTest {
    ...
    private final Message m1 = new Message("some-id-1", MessageType.TEST_HP, "content", dt1);
    private final Message m2 = new Message("some-id-2", MessageType.TEST_HP, "content", dt2);
